    ...
    <>
      <div className="side h-[100vh] w-[10rem] sm:w-[15rem] bg-gray-900 left-0">
        <div className="flex flex-col  items-center pl-2 text-white flex-wraptext pt-10 gap-6 h-[80%] w-[80%]">
          <div className="home hover:bg-zinc-400 gap-3 border w-[100%] justify-center items-center flex p-2 rounded">
            <img src={home} className="w-[25px]" alt="home" /> Home
          </div>
          <div className="recent gap-3 hover:bg-zinc-400  border w-[100%] justify-center items-center rounded flex p-2">
            <img src={recents} className="w-[25px]" alt="home" />
            Recently played
          </div>
          <div className="collections gap-3 hover:bg-zinc-400 border w-[100%] justify-center items-center rounded p-2 flex">
            <img src={collections} className="w-[25px]" alt="home" />{" "}
            Collections
          </div>
          <div className="playlists gap-3 hover:bg-zinc-400 border w-[100%] justify-center items-center rounded p-2 flex">
            <img src={playlists} className="w-[25px]" alt="home" /> Playlists
          </div>
          <div className="create gap-3 hover:bg-zinc-400 border w-[100%] justify-center items-center rounded flex p-2">
            <img src={createPlaylist} className="w-[25px]" alt="home" /> Create
            playlist
          </div>
